package ei.diego.tasks.repository;
...
public class TaskCustomRepository {
    ...
    public Page<Task> findPaginated(Task task, Integer page, Integer size) {
        ...
        return PageableExecutionUtils.getPage(mongoOperations.find(query, Task.class),
                pageable, () -> mongoOperations.count(query, Task.class));
    }
